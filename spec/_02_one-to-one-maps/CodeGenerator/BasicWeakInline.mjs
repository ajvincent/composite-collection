...
import OneToOneMap from "../generated/BasicWeakInline.mjs";

describe("CodeGenerator(OneToOneBasicWeakInline.mjs)", () => {
  let map;
  ...
  it("creates the WeakStrongMap class in the module", async () => {
    await expectAsync(
      hasClassInSource("./spec/_02_one-to-one-maps/generated/BasicWeakInline.mjs", "WeakWeakMap")
    ).toBeResolvedTo(true);
  });
});
